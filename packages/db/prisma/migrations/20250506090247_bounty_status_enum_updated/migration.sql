/*
  ...
  - The values [PAID] on the enum `BountyStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "BountyStatus_new" AS ENUM ('PENDING', 'ACTIVE', 'CLAIMED', 'APPROVING', 'APPROVED', 'CANCELLING', 'CANCELED', 'FAILED');
