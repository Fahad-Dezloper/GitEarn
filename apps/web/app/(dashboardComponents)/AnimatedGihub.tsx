    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center">
          <Circle className="rotate-270" ref={div7Ref}>
            <Icons.user />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle className="rotate-270" ref={div6Ref}>
          <GithubIcon className="text-black hover:bg-transparent" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle className="rotate-270" ref={div1Ref}>
            <Icons.user />
          </Circle>
          <Circle className="rotate-270" ref={div2Ref}>
            <Icons.user />
          </Circle>
          <Circle className="rotate-270" ref={div3Ref}>
            <Icons.user />
          </Circle>
          <Circle className="rotate-270" ref={div4Ref}>
            <Icons.user />
          </Circle>
          <Circle className="rotate-270" ref={div5Ref}>
            <Icons.user />
          </Circle>
        </div>
      </div>
