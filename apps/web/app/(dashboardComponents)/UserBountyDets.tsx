                ...
                <div className='flex gap-6 '>
                    <div className='flex gap-3 items-start justify-center'>
                        ...
                        <div>
                            <div className="leading-none flex flex-col gap-1 mt-1">
                                <p className="font-semibold text-gray-800 dark:text-gray-100 font-sora">$1000</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Total Bounty Earned</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 items-start justify-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Total Issues Solved</p>
                        </div>
                    </div>
                </div>
            </div>
