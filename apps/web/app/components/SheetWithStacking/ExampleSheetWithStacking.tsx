...
const ExampleSheetWithStackingView = ({ data }: any) => {
  ...
  return (
    <SheetWithStackingView className="z-50 bg-blue-500" onTravelStatusChange={travelStatusChangeHandler}>
...
const ExampleSheetWithStacking = ({ data }: any) => {
  return (
    <SheetWithStackingStack>
      <SheetWithStackingRoot>
        <Sheet.Trigger className="relative ">
          <span className="absolute top-0 bottom-0 left-0 right-0"><ArchiveIcon size={20} /></span>
          <ArchiveIcon size={20} />
        </Sheet.Trigger>
